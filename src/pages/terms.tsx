    ...
    return (
        <>
            ...
            <Container>
                ...
                <Section>
                    <Heading as="h2">Vulputate dignissim</Heading>
                    <p>
                        Nisi lacus sed viverra tellus in hac. Integer malesuada
                        nunc vel risus commodo. Purus viverra accumsan in nisl
                        nisi scelerisque. Duis ultricies lacus sed turpis
                        tincidunt id aliquet risus. Convallis a cras semper
                        auctor neque. Sit amet nulla facilisi morbi tempus
                        iaculis. In nisl nisi scelerisque eu ultrices vitae.
                        Ultricies lacus sed turpis tincidunt id aliquet risus.
                        Dictum fusce ut placerat orci. Vestibulum rhoncus est
                        pellentesque elit ullamcorper dignissim cras tincidunt
                        lobortis. Vulputate dignissim suspendisse in est ante.
                    </p>
                </Section>
            </Container>
        </>
...
TermsPage.layout = ({ children }) => <BaseLayout>{children}</BaseLayout>
